            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('instructor.index') }}">Tất cả giảng viên</a>
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="nav nav-pills mb-3">
                        ...
                        {{-- <li class="nav-item"><a href="#grid-view" data-toggle="tab" class="nav-link btn-primary">Xem dạng
                                lưới</a></li> --}}
                    </ul>
                </div>
                <div class="col-lg-12">
                                    ...
                                    <div class="table-responsive">
                                        <table id="example3" class="display" style="min-width: 845px">
                                            ...
                                            <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img class="rounded-circle" width="40" height="40"
                                                                src="{{ asset('uploads/users/' . $d->image) }}"
                                                                alt="">
                                                        </td>
                                                ...
                                                @empty
                                                    <tr>
                                                        <th colspan="7" class="text-center">Không tìm thấy giảng viên
                                                        </th>
                                                    </tr>
                                                @endforelse
                                            </tbody>
                                            ...
                                            <div class="card-body pt-2">
                                                <div class="text-center">
                                                    <div class="profile-photo">
                                                        <img src="{{ asset('uploads/instructors/' . $d->image) }}"
