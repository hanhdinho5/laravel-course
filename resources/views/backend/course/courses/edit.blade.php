            ...
            <div class="row">
                <div class="col-xl-12 col-xxl-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            @if (fullAccess())
                                <form action="{{ route('course.updateforAdmin', encryptor('encrypt', $course->id)) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="status">
                                                    <option value="0"
                                                        @if (old('status', $course->status) == 0) selected @endif>Chưa giải quyết
                                                    </option>
                                                    <option value="1"
                                                        @if (old('status', $course->status) == 1) selected @endif>Không hoạt động
                                                    </option>
                                                    <option value="2"
                                                        @if (old('status', $course->status) == 2) selected @endif>Tích cực</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="courseTitle_en"
                                                    value="{{ old('courseTitle_en', $course->title) }}">
                                            </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            ...
                                            @if ($errors->has('courseDescription_en'))
                                                <span class="text-danger">
                                                    {{ $errors->first('courseDescription_en') }}</span>
                                            @endif
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="categoryId">
                                                    @forelse ($courseCategory as $c)
                                                        <option value="{{ $c->id }}"
                                                            {{ old('categoryId', $course->course_category_id) == $c->id ? 'selected' : '' }}>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="instructorId">
                                                    @forelse ($instructor as $i)
                                                        <option value="{{ $i->id }}"
                                                            {{ old('instructorId', $course->instructor_id) == $i->id ? 'selected' : '' }}>
                                                            {{ $i->name_en }}</option>
                                                    @empty
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="courseDifficulty">
                                                    <option value="beginner"
                                                        @if (old('courseDifficulty', $course->difficulty) == 'beginner') selected @endif>Người mới bắt đầu
                                                    </option>
                                                    <option value="intermediate"
                                                        @if (old('courseDifficulty', $course->difficulty) == 'intermediate') selected @endif>Trung cấp
                                                    </option>
                                                    <option value="advanced"
                                                        @if (old('courseDifficulty', $course->difficulty) == 'advanced') selected @endif>Trình độ cao
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        {{-- <div class="col-lg-6 col-md-6 col-sm-12">
                                            ...
                                            @if ($errors->has('subscription_price'))
                                                <span class="text-danger">
                                                    {{ $errors->first('subscription_price', $course->subscription_price) }}</span>
                                            @endif
                                        </div> --}}
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                            ...
                                            @if ($errors->has('start_from'))
                                                <span class="text-danger">
                                                    {{ $errors->first('start_from', $course->start_from) }}</span>
                                            @endif
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="tag">
                                                    <option value="popular"
                                                        @if (old('tag', $course->tag) == 'popular') selected @endif>Phổ biến
                                                    </option>
                                                    <option value="featured"
                                                        @if (old('tag', $course->tag) == 'featured') selected @endif>Nổi bật
                                                    </option>tag
                                                    <option value="upcoming"
                                                        @if (old('tag', $course->tag) == 'upcoming') selected @endif>Sắp tới</option>
                                                </select>
                                            </div>
                                            @if ($errors->has('tag'))
