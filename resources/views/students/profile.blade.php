                        ...
                        <div class="students-info-intro-end">
                            <div class="enrolled-courses">
                                ...
                                <div class="enrolled-courses-text">
                                    ...
                                    <p class="fs-6 mt-1">Khoá học đã đăng ký</p>
                                </div>
                            </div>
                            <div class="completed-courses">
                                ...
                                <div class="completed-courses-text">
                                    ...
                                    <p class="fs-6 mt-1">Khoá học đã hoàn thành</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <nav class="students-info-intro__nav">
                    <div class="nav" id="nav-tab" role="tablist">
                        <button class="nav-link active" id="nav-profile-tab" data-bs-toggle="tab"
                            ...
                            aria-selected="true">Hồ sơ của tôi</button>
                        ...
                        <div class="tab-content__profile">
                            <div class="tab-content__profile-content">
                                <div class="about-student">
                                    <h6 class="font-title--card">Giới thiệu về tôi</h6>
                                    <p class="font-para--md">
                                        {{ $student_info->bio ? $student_info->bio : 'Tiểu sử học viên' }}
                                    </p>
                                </div>
                            </div>
                            <div class="tab-content__profile-content">
                                <div class="info-student">
                                    <h6 class="font-title--card">Thông tin tôi {{ $student_info->name_en }}</h6>
                                    ...
                                    <dl class="row my-0 info-student-topic">
                                        ...
                                        <dd class="col-sm-8">
                                            <p>{{ $student_info->contact_en ? $student_info->contact_en : '+84' }}</p>
                                        </dd>
                                    </dl>
                                    <dl class="row my-0 info-student-topic">
                                        <dt class="col-sm-4">
                        ...
                        <div class="row">
                            <div class="col-lg-9 order-2 order-lg-0">
                                <div class="white-bg">
                                    <div class="students-info-form">
                                        ...
                                        <form action="{{ route('student_save_profile') }}" method="post">
                                            ...
                                            <div class="row g-3">
                                                <div class="col-lg-6">
                                                    <label for="contactNumber_en">Điện thoại</label>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <textarea name="bio" class="form-control" rows="5">{{ $student_info->bio }}</textarea>
                                                </div>
                                            </div>
                                            <div class="d-flex justify-content-lg-end justify-content-center mt-2">
                                                <button class="button button-lg button--primary" type="submit">Lưu thay
                                                    đổi</button>
                                            </div>
                                        </form>
                                    </div>
                                ...
                                <div class="white-bg mt-4">
                                    <div class="students-info-form">
                                        <h6 class="font-title--card">Thay đổi mật khẩu</h6>
                                        ...
                                        <form id="changeImageForm" action="{{ route('change_image') }}" method="post"
                                            ...
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <button type="button" id="changeImageButton"
                                                    class="button button--primary-outline">Lưu avatar</button>
                                            </div>
                                        </form>
