        ...
        <div class="container">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb align-items-center bg-transparent mb-0">
                    ...
                    <li class="breadcrumb-item fs-6 text-secondary" aria-current="page">Hồ sơ của tôi</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container">
                ...
                <div class="students-info-intro__profile">
                    <div>
                        <div class="students-info-intro-start">
                            <div class="image">
                                <img src="{{ asset('uploads/students/' . ($student_info->image ?? 'avatar.png')) }}"
                                    alt="Student" />
                            </div>
                            <div class="text">
                                <h5>{{ $student_info->name_en }}</h5>
                                <p>{{ $student_info->profession ? $student_info->profession : 'Học viên' }}</p>
                            </div>
                        </div>
                    </div>
                    <div>
                        <div class="students-info-intro-end">
                            <div class="enrolled-courses">
                                ...
                                <div class="enrolled-courses-text">
                                    ...
                                    <p class="fs-6 mt-1">Khoá học đăng ký</p>
                                </div>
                            </div>
                            <div class="completed-courses">
                                ...
                                <div class="completed-courses-text">
                                    ...
                                    <p class="fs-6 mt-1">Khoá học hoàn thành</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <nav class="students-info-intro__nav">
                    <div class="nav" id="nav-tab" role="tablist">
                        ...
                        <button class="nav-link" id="nav-coursesall-tab" data-bs-toggle="tab"
                            ...
                            aria-selected="false">Khoá học đã đăng ký</button>
                        ...
                        <button class="nav-link "><a href="{{ route('student_profile') }}" class="text-secondary">Hồ
                                sơ</a></button>

                        <button class="nav-link "><a href="{{ route('home') }}" class="text-secondary">Trang
                                chủ</a></button>
                    </div>
                </nav>
            </div>
            ...
            <div class="students-info-main">
                <div class="tab-content" id="nav-tabContent">
                    {{-- Profile Info --}}
                    <div class="tab-pane fade show active w-100" id="nav-profile" role="tabpanel"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12 mx-auto text-center">
                                            ...
                                            <p class="my-4 font-para--lg">
                                                Bạn có thể có được câu trả lời đầy đủ cho sự nghiệp khi đăng ký học với
                                                chúng tôi
                                            </p>
                                            <a href="{{ route('searchCourse') }}"
                                                class="button button-md button--primary">Đăng ký khoá học ngay</a>
                                        </div>
                                    </div>
                                </div>
                            </section>
                                                ...
                                                <tbody>
                                                    @foreach ($pendingOrders as $order)
                                                        <tr>
                                                            ...
                                                            <td>{{ number_format((float) $order->amount, 0) }} VNĐ</td>
                                                            <td>{{ $order->created_at }}</td>
                                                            <td><button disabled class="btn btn-warning btn-sm">Chờ thanh
                                                                    toán
                                                            </td>
                                                            <td>
                        ...
                        <div class="row">
                            ...
                            @empty
                                <div class="col-12 py-5">
                                    <div class="col-md-6 col-12 mx-auto text-center">
                                        <h5 class="font-title--sm">Bạn chưa đăng ký khoá học nào ...</h5>
                                        <p class="my-4 font-para--lg">
                                            Danh sách khóa học của bạn đang trống!
                                        </p>
                                        <a href="{{ route('searchCourse') }}"
                                            class="button button-md button--primary">Đăng ký ngay!</a>
                                    </div>
                                </div>
                            @endforelse
