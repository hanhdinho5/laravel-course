...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-7 mb-lg-0 order-2 order-lg-0 d-flex align-items-center">
                    <div class="banner-two-start">
                        <h1 class="font-title--lg">Khai phá Kiến thức mọi lúc, mọi nơi cùng Chuyên gia.</h1>
                        <p>
                    ...
                    <div class="tab-pane fade show active" id="pills-all" role="tabpanel" aria-labelledby="pills-all-tab">
                        <div class="row">
                            ...
                            @empty
                                <div class="col-xl-4 col-md-6">
                                    <div class="contentCard contentCard--course">
                                        <h3>Không có khóa học nào có sẵn</h3>
                                    </div>
                                </div>
                            @endforelse
                        </div>
    ...
    <section class="section feature section section--bg-offwhite-one">
        <div class="container">
            <h2 class="font-title--md text-center">Tại sao bạn nên học Eduguard</h2>
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="cardFeature">
                        ...
                        <h5 class="font-title--xs">khoá học trực tuyến tiện lợi</h5>
                        <p>
                            Với Eduguard, bạn có thể học ở bất cứ đâu và bất kỳ lúc nào chỉ với một thiết bị có kết nối
                            Internet. Các bài học được thiết kế linh hoạt, chia nhỏ theo từng chủ đề giúp bạn dễ dàng tiếp
                            thu và sắp xếp thời gian học phù hợp với lịch trình cá nhân. Trải nghiệm học tập trực tuyến hiện
                            đại giúp bạn tiết kiệm thời gian nhưng vẫn đảm bảo hiệu quả cao.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="cardFeature">
                        ...
                        <h5 class="font-title--xs">Giảng viên chuyên gia</h5>
                        <p>
                            Đội ngũ giảng viên tại Eduguard đều là những chuyên gia giàu kinh nghiệm thực tiễn, luôn cập
                            nhật kiến thức mới và phương pháp giảng dạy hiện đại. Bạn sẽ được học từ những người thực hành
                            nhiều năm trong lĩnh vực, mang đến những bài học chất lượng, dễ hiểu và mang tính ứng dụng cao.
                            Mỗi khóa học đều có hỗ trợ giải đáp, đảm bảo bạn không gặp khó khăn khi tự học.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="cardFeature">
                        ...
                        <p>
                            Khi đăng ký khóa học, bạn nhận ngay quyền truy cập vĩnh viễn vào toàn bộ nội dung, bao gồm cả
                            những lần cập nhật nội dung mới trong tương lai. Bạn hoàn toàn có thể quay lại xem lại bài học
                            bất cứ lúc nào để ôn luyện, củng cố kiến thức hoặc cập nhật các kiến thức mới nhất mà không tốn
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 position-relative">
                    <h3 class="text-center mb-40 font-title--md">Gặp gỡ giảng viên giỏi nhất của chúng tôi</h3>
                ...
                <div class="col-lg-8 mx-auto">
                    <div class="newsletter-area">
                        ...
                        <p class="mt-2 mb-lg-4 mb-3">
                            Bạn hoàn toàn có thể đạt được kết quả tốt nhất khi áp dụng đúng phương pháp học tập. Với sự tập
                            trung và chiến lược phù hợp, ngay cả những thách thức khó cũng trở nên dễ dàng và bạn sẽ tiến bộ
                            nhanh hơn mong đợi </p>
                        <form>
