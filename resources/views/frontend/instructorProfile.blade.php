        ...
        <div class="container">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="course-search.html" class="fs-6 text-secondary">Khóa học</a></li>
                    <li class="breadcrumb-item d-none d-lg-inline-block"><a href="#" class="fs-6 text-secondary">Chi
                            tiết khóa học</a></li>
                ...
                <div class="col-lg-4">
                    <div class="instructor-courses-instructor">
                        <div class="instructor-image mx-auto text-center">
                            <img src="{{ $instructor->image ? asset('uploads/users/' . $instructor->image) : asset('images/avatar/1.png') }}" alt="Instructor" />
                        </div>
                        ...
                        <div class="instructor-qualification">
                            ...
                            <div class="qualification-info">
                                ...
                                <p>
                                    Trường Nghệ thuật và Thương mại Gonzalo Puyat
                                </p>
                            </div>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="students-feedback">
                                            <div class="students-feedback-heading">
                                                <h5>Đánh giá của học viên <span>(57,685)</span></h5>
                                                <div class="right">
                                                    <h6>Sắp xếp theo:</h6>
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                                            <li><button class="dropdown-item" type="button">Theo xếp
                                                                    hạng</button></li>
                                                            <li><button class="dropdown-item" type="button">Xếp hạng
                                                                    khác</button></li>
                                                            <li><button class="dropdown-item" type="button">Các xếp hạng
                                                                    khác</button></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="students-feedback-item">
                                                ...
                                                <p>
                                                    ...
                                                    Cras non molestie diam. Khóa học rất tuyệt vời cho người mới bắt đầu 😀
                                                </p>
                                            </div>
                                            ...
                                            <div class="students-feedback-item">
                                                ...
                                                <p>
                                                    ...
                                                    vestibulum massa eget consequat scelerisque.
                                        ...
                                        <div class="feedback-comment">
                                            <h6 class="font-title--card">Để lại đánh giá</h6>
                                            <span>Đánh giá</span>
                                            <!-- <div id="my-rating"></div> -->
                                            <div class="my-rating rating-icons rating-icons-modal"></div>
                                            <form action="#">
                                                <label for="comment">Bình luận</label>
                                                <textarea class="form-control" id="comment" placeholder="Bạn cảm thấy thế nào về giảng viên này"></textarea>
                                                <button type="submit"
                                                    class="button button-lg button--primary float-end">Gửi đánh giá</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
